...
<body>
<h3 style="margin-right:90%"><a href="hospitalindex.html">HOME</a></h3>
...
<table  border="1" width="90%">
        ...
        ResultSet rs = stmt.executeQuery("select*from rhospital where hid='"+id+"' and rstatus='"+"not approved"+"' "); 
        ...
        %>
          <tr>
             ...
             <td><%out.println(bld);%></td>
              ...
              <td><a href="Accept.jsp?uid=<%out.println(id);%>">Accept</a></td>

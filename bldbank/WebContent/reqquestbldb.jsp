...
<link rel="stylesheet" href ="innerdesign5css.css"/>
<a href="userindex.jsp"><font color="blue">Home</font></a>
...
<input type="text" name="type" value="doner" readonly/>
<tr><td>Name</td><td>
...
<tr><td>Adhaar_no</td><td>
<input type="text" name="adhaar" value="" required/>
</td></tr>
<tr><td>Gender</td><td>

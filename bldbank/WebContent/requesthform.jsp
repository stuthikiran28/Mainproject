...
<html>
    ...
    <body>
       ...
       stmt.executeUpdate("insert into rhospital(uid , hname , hlocation , rname , rnumber , rgender , rAdhaar_no , rblod ,rstatus,rtype,rage ,rlocation)value('"+uid+"','"+hname+"','"+hloc+"','"+rname+"','"+rmob+"','"+rgen+"','"+radhaar+"','"+rbld+"','"+rstatus+"','"+type+"','"+rage+"', '"+radd+"') ");
